                ...
                <div className="bi_basicInfo">
                    ...
                    <div className="bi_basicInfo_box">
                        <ul>
                            ...
                            <li><span className="bi_basicInfo_box_item_k">国家：</span><span>中国</span></li>
                            <li><span className="bi_basicInfo_box_item_k">经度：</span><span>120.12421</span></li>
                            <li><span className="bi_basicInfo_box_item_k">纬度：</span><span>35.21648</span></li>
                        </ul>
                        <div className="bi_basicInfo_desc">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此港是一个小型港口，该港属于中国，该港最多可容纳13条船，包含货船、邮轮、渔船，允许停泊船只的最大长度129米，最大宽度是20米，最大吃水深度是6米。
                        </div>
                    </div>
                </div>
